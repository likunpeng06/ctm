...
<frame:frame>
    <div class="container-fluid">
        <div class="panel panel-default">
            <div class="panel-heading">修改游戏</div>
            <div class="panel-body">
                <form:form class="form-horizontal" action="${ctx}/game/update" method="post" commandName="gameForm">
                    <input type="hidden" name="game.id" value="${gameForm.game.id}"/>
                    <form:errors path="*" cssClass="alert alert-danger" element="div" role="alert"/>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">游戏名</label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" name="game.name" value="${gameForm.game.name}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">iconUrl</label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" name="game.iconUrl" value="${gameForm.game.iconUrl}">
                        </div>
                    </div>
                    <div class="form-group">
