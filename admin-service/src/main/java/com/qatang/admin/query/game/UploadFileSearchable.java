 ...
 */
public class UploadFileSearchable extends AbstractSearchable<UploadFile> {
    private String id;
    private String name;
    ...
    @Override
    protected Predicate createPredicate(Root<UploadFile> root, CriteriaQuery<?> criteriaQuery, CriteriaBuilder criteriaBuilder) {
